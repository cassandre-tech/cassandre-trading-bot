...
-- =====================================================================================================================
-- Insert orders.
INSERT INTO ORDERS (ID, ORDER_ID, TYPE, AMOUNT_VALUE, AMOUNT_CURRENCY, CURRENCY_PAIR, USER_REFERENCE, TIMESTAMP, STATUS, CUMULATIVE_AMOUNT_VALUE,
                    CUMULATIVE_AMOUNT_CURRENCY, AVERAGE_PRICE_VALUE, AVERAGE_PRICE_CURRENCY, LEVERAGE, LIMIT_PRICE_VALUE, LIMIT_PRICE_CURRENCY, FK_STRATEGY_ID)
VALUES -- Order BACKUP_ORDER_01 (useless).
       (1, 'BACKUP_ORDER_01', 'ASK', 0.000005, 'ETH', 'ETH/BTC', 'My reference 1', '2020-11-18', 'NEW', 0.000004, 'ETH', 0.000003, 'BTC',
        'LEVERAGE_1', 0.000001, 'BTC', 1),

       -- Order BACKUP_ORDER_02 (useless).
       (2, 'BACKUP_ORDER_02', 'BID', 0.000015, 'USDT', 'USDT/BTC', 'My reference 2', '2020-11-19', 'PENDING_NEW', 0.000014, 'USDT',
        0.000013, 'BTC', 'LEVERAGE_2', 0.000011, 'BTC', 1),

       -- For position 1 (OPENING).
       (3, 'BACKUP_OPENING_ORDER_01', 'BID', 10, 'BTC', 'BTC/USDT', '', '2020-11-20', 'NEW', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),

       -- For position 2 (OPENED).
       (4, 'BACKUP_OPENING_ORDER_02', 'BID', 20, 'BTC', 'BTC/USDT', '', '2020-11-20', 'FILLED', 20, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),

       -- For position 3 (CLOSING).
       (5, 'BACKUP_OPENING_ORDER_03', 'BID', 30, 'BTC', 'BTC/USDT', '', '2020-11-20', 'FILLED', 30, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
       (6, 'BACKUP_CLOSING_ORDER_01', 'ASK', 30, 'BTC', 'BTC/USDT', '', '2020-11-20', 'NEW', 30, 'BTC', 1, 'USDT', 1, 1, 'USDT', 1),

       -- For position 4 (CLOSED).
       (7, 'BACKUP_OPENING_ORDER_04', 'BID', 40, 'BTC', 'BTC/USDT', '', '2020-11-20', 'FILLED', 40, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
       (8, 'BACKUP_CLOSING_ORDER_02', 'ASK', 40, 'BTC', 'BTC/USDT', '', '2020-11-20', 'FILLED', 40, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),

       -- For position 4 (CLOSED).
       (9, 'BACKUP_OPENING_ORDER_05', 'BID', 50, 'ETH', 'ETH/USD', '', '2020-11-20', 'FILLED', 50, 'ETH', 1, 'ETH', '', 1, 'USDT', 1),
       (10, 'BACKUP_CLOSING_ORDER_03', 'ASK', 50, 'ETH', 'ETH/USD', '', '2020-11-20', 'FILLED', 50, 'ETH', 1, 'ETH', '', 1, 'USDT', 1);

-- =====================================================================================================================
-- Insert positions.
INSERT INTO POSITIONS (ID, POSITION_ID, TYPE, STATUS, CURRENCY_PAIR, AMOUNT_VALUE, AMOUNT_CURRENCY, RULES_STOP_GAIN_PERCENTAGE, RULES_STOP_LOSS_PERCENTAGE,

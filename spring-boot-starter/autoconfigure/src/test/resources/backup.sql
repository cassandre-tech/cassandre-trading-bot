...
VALUES -- Order BACKUP_ORDER_01 (useless).
       ...
       (2, 'BACKUP_ORDER_02', 'BID', 0.000015, 'USDT', 'USDT/BTC', 'My reference 2', '2020-11-19', 'PENDING_NEW',
        0.000014, 'USDT', 0.000013, 'BTC', 'LEVERAGE_2', 0.000011, 'BTC', 1),
...
VALUES -- note : No trade for order BACKUP_OPENING_ORDER_01 - This is why position 1 has the opening status.
       ...
       (1, 'BACKUP_TRADE_01', 'BACKUP_OPENING_ORDER_02', 4, 'BID', 20, 'BTC', 'BTC/USDT', 10, 'USDT', '2020-08-01', 1,
        'USDT', 'Trade 01'),
       ...
       (3, 'BACKUP_TRADE_03', 'BACKUP_OPENING_ORDER_04', 7, 'BID', 40, 'BTC', 'BTC/USDT', 30, 'USDT', '2020-08-03', 3,
        'USDT', 'Trade 03'),
       ...
       (5, 'BACKUP_TRADE_05', 'BACKUP_CLOSING_ORDER_02', 8, 'ASK', 50, 'ETH', 'ETH/USD', 50, 'USD', '2020-08-05', 5,
        'USD', 'Trade 05'),

       -- For position 5.
       (6, 'BACKUP_TRADE_06', 'BACKUP_OPENING_ORDER_05', 9, 'BID', 10, 'ETH', 'ETH/USD', 11, 'USD', '2020-08-05', 5,
        'USD', 'Trade 06'),
       (7, 'BACKUP_TRADE_07', 'BACKUP_OPENING_ORDER_05', 9, 'BID', 40, 'ETH', 'ETH/USD', 12, 'USD', '2020-08-06', 5,
        'USD', 'Trade 07'),
       (8, 'BACKUP_TRADE_08', 'BACKUP_CLOSING_ORDER_03', 10, 'ASK', 15, 'ETH', 'ETH/USD', 13, 'USD', '2020-08-07', 5,
        'USD', 'Trade 08'),
       (9, 'BACKUP_TRADE_09', 'BACKUP_CLOSING_ORDER_03', 10, 'ASK', 5, 'ETH', 'ETH/USD', 14, 'USD', '2020-08-08', 5,
        'USD', 'Trade 09'),
       (10, 'BACKUP_TRADE_10', 'BACKUP_CLOSING_ORDER_03', 10, 'ASK', 30, 'ETH', 'ETH/USD', 15, 'USD', '2020-08-09', 5,
        'USD', 'Trade 10');
...
-- Position 1.
INSERT INTO public.positions    (uid, position_id, type, fk_strategy_id, currency_pair, amount_value, amount_currency, rules_stop_gain_percentage, rules_stop_loss_percentage, status, fk_opening_order_id, fk_closing_order_id, lowest_gain_price_value, lowest_gain_price_currency, highest_gain_price_value, highest_gain_price_currency, latest_gain_price_value, latest_gain_price_currency, created_on, updated_on, force_closing, base_currency_precision, quote_currency_precision)
VALUES                          (1, 1, 'LONG', 1, 'SHIB/USDT', 0.02000000, 'ETH', 6, 15, 'CLOSED', 1, 2, 3660.11000000, 'USDT', 4079.63000000, 'USDT', 4081.86000000, 'USDT', '2021-10-17 14:47:11.714212', '2021-10-20 18:01:10.401066', false, 1, 2);

-- Position 2.
INSERT INTO public.positions    (uid, position_id, type, fk_strategy_id, currency_pair, amount_value, amount_currency, rules_stop_gain_percentage, rules_stop_loss_percentage, status, fk_opening_order_id, fk_closing_order_id, lowest_gain_price_value, lowest_gain_price_currency, highest_gain_price_value, highest_gain_price_currency, latest_gain_price_value, latest_gain_price_currency, created_on, updated_on, force_closing, base_currency_precision, quote_currency_precision)
VALUES                          (2, 2, 'LONG', 1, 'ETH/BTC', 0.02000000, 'ETH', 6, 15, 'CLOSED', 11, 13, 3660.11000000, 'USDT', 4083.52000000, 'USDT', 4126.82000000, 'USDT', '2021-10-17 15:47:11.809771', '2021-10-21 16:48:11.372994', false, 3, 4);

-- Trades for order 1.
INSERT INTO public.trades   (uid, trade_id, type, fk_order_id, currency_pair, amount_value, amount_currency, price_value, price_currency, fee_value, fee_currency, user_reference, timestamp, created_on, updated_on)

...
-- Position 1.
INSERT INTO public.positions    (uid, position_id, type, fk_strategy_uid, currency_pair, amount_value, amount_currency, rules_stop_gain_percentage, rules_stop_loss_percentage, status, FK_OPENING_ORDER_UID, FK_CLOSING_ORDER_UID, lowest_gain_price_value, lowest_gain_price_currency, highest_gain_price_value, highest_gain_price_currency, latest_gain_price_value, latest_gain_price_currency, created_on, updated_on, force_closing, base_currency_precision, quote_currency_precision)

...
values  -- For position 1.
        (1, 'OPEN_ORDER_01', 'BID', 10, 'BTC', 'ETH/BTC', '', '2020-11-20', 'FILLED', 10, 'BTC', 1, 'USDT' , '', 1, 'USDT', 1),
        (2, 'CLOSE_ORDER_01', 'ASK', 10, 'BTC', 'ETH/BTC', '', '2020-11-20', 'FILLED', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
        -- For position 2.
        ...
        -- For position 3.
        (5, 'OPEN_ORDER_03', 'BID', 30, 'BTC', 'ETH/BTC', '', '2020-11-20', 'FILLED', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
        (6, 'CLOSE_ORDER_03', 'ASK', 30, 'BTC', 'ETH/BTC', '', '2020-11-20', 'FILLED', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
        -- For position 4.
        (7, 'OPEN_ORDER_04', 'BID', 50, 'BTC', 'ETH/BTC', '', '2020-11-20', 'NEW', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
        (8, 'CLOSE_ORDER_04', 'ASK', 50, 'BTC', 'ETH/BTC', '', '2020-11-20', 'NEW', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
        -- For position 5.
        (9, 'OPEN_ORDER_05', 'BID', 50, 'BTC', 'ETH/BTC', '', '2020-11-20', 'FILLED', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
        (10, 'CLOSE_ORDER_05', 'ASK', 50, 'BTC', 'ETH/BTC', '', '2020-11-20', 'NEW', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
        -- For position 6.
        (11, 'OPEN_ORDER_06', 'BID', 50, 'BTC', 'ETH/BTC', '', '2020-11-20', 'FILLED', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1),
        (12, 'CLOSE_ORDER_06', 'ASK', 50, 'BTC', 'ETH/BTC', '', '2020-11-20', 'NEW', 10, 'BTC', 1, 'USDT', '', 1, 'USDT', 1);
...
INSERT INTO POSITIONS (ID, POSITION_ID, TYPE, STATUS, CURRENCY_PAIR, AMOUNT_VALUE, AMOUNT_CURRENCY,
                       ...
                       FK_OPENING_ORDER_ID, CLOSING_ORDER_ID, FK_CLOSING_ORDER_ID, LOWEST_PRICE_VALUE,
                       HIGHEST_PRICE_VALUE, LATEST_PRICE_VALUE, LOWEST_PRICE_CURRENCY, HIGHEST_PRICE_CURRENCY,
                       LATEST_PRICE_CURRENCY, FK_STRATEGY_ID)
VALUES (1, 1, 'LONG', 'CLOSED', 'ETH/BTC', 10, 'BTC', null, null, 'OPEN_ORDER_01', 1, 'CLOSE_ORDER_01', 2, null, null, null, null, null, null, 1),
       (2, 2, 'LONG', 'CLOSED', 'ETH/BTC', 20, 'ETH', null, null, 'OPEN_ORDER_02', 3, 'CLOSE_ORDER_02', 4, null, null, null, null, null, null, 1),
       (3, 3, 'LONG', 'CLOSED', 'ETH/BTC', 30, 'BTC', null, null, 'OPEN_ORDER_03', 5, 'CLOSE_ORDER_03', 6, null, null, null, null, null, null, 1),
       (4, 4, 'LONG', 'OPENING', 'ETH/BTC', 50, 'BTC', null, null, 'OPEN_ORDER_04', 7, 'CLOSE_ORDER_04', 8, null, null, null, null, null, null, 1),
       (5, 5, 'LONG', 'OPENED', 'ETH/BTC', 50, 'BTC', null, null, 'OPEN_ORDER_05', 9, null, null, null, null, null, null, null, null, 1),
       (6, 6, 'LONG', 'CLOSING', 'ETH/BTC', 50, 'BTC', null, null, 'OPEN_ORDER_06', 11, 'CLOSE_ORDER_06', 12, null, null, null, null, null, null, 1);

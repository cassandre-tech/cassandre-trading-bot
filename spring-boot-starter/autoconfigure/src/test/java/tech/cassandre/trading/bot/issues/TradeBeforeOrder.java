...
@DisplayName("Github issues - Trade before order - 426")
@Configuration({
        @Property(key = PARAMETER_EXCHANGE_DRY, value = "true")
})
@DirtiesContext(classMode = BEFORE_EACH_TEST_METHOD)
@Import(TradeBeforeOrderMock.class)
public class TradeBeforeOrder extends BaseTest {
    ...
    @Test
    @DisplayName("Check trade before order")

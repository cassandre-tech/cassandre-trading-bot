...
@TestConfiguration
public class BasicTa4JCassandreStrategyDbTestMock extends BaseDbTest {
    ...
    public MarketService marketService() {
        ...
        given(service.getTicker(BTC_USDT)).willReturn(
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(1))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(2))
                        .open(new BigDecimal(100))
                        .high(new BigDecimal(100))
                        .low(new BigDecimal(100))
                        .last(new BigDecimal(100))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(3))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(4))
                        .open(new BigDecimal(100))
                        .high(new BigDecimal(100))
                        .low(new BigDecimal(100))
                        .last(new BigDecimal(100))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(5))
                ...
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(6))
                        .open(new BigDecimal(100))
                        .high(new BigDecimal(100))
                        .low(new BigDecimal(100))
                        .last(new BigDecimal(100))
                ...
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(7))
                ...
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(8))
                        .open(new BigDecimal(100))
                        .high(new BigDecimal(100))
                        .low(new BigDecimal(100))
                        .last(new BigDecimal(100))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(9))
                        .open(new BigDecimal(100))
                        .high(new BigDecimal(100))
                        .low(new BigDecimal(100))
                        .last(new BigDecimal(100))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(10))
                        .open(new BigDecimal(100))
                        .high(new BigDecimal(100))
                        .low(new BigDecimal(100))
                        .last(new BigDecimal(100))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(11))
                        .open(new BigDecimal(110))
                        .high(new BigDecimal(110))
                        .low(new BigDecimal(110))
                        .last(new BigDecimal(110))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(12))
                        .open(new BigDecimal(100))
                        .high(new BigDecimal(100))
                        .low(new BigDecimal(100))
                        .last(new BigDecimal(100))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(13))
                ...
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(14))
                        .open(new BigDecimal(100))
                        .high(new BigDecimal(100))
                        .low(new BigDecimal(100))
                        .last(new BigDecimal(100))
                        ...
                        .build()),
                Optional.of(TickerDTO.builder().currencyPair(BTC_USDT)
                        .timestamp(BaseDbTest.createZonedDateTime(15))

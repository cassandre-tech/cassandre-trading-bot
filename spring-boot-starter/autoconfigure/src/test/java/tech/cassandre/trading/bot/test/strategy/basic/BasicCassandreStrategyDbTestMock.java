...
@TestConfiguration
public class BasicCassandreStrategyDbTestMock extends BaseDbTest {
    ...
    public MarketService marketService() {
        ...
        given(service.getTicker(ETH_BTC)).willReturn(
                BaseDbTest.getFakeTicker(ETH_BTC, new BigDecimal("1")),
                BaseDbTest.getFakeTicker(ETH_BTC, new BigDecimal("2")),
                BaseDbTest.getFakeTicker(ETH_BTC, new BigDecimal("3")),
                BaseDbTest.getFakeTicker(ETH_BTC, new BigDecimal("4")),
                BaseDbTest.getFakeTicker(ETH_BTC, new BigDecimal("5")),
                BaseDbTest.getFakeTicker(ETH_BTC, new BigDecimal("6"))
        );
        given(service.getTicker(ETH_USDT)).willReturn(
                BaseDbTest.getFakeTicker(ETH_USDT, new BigDecimal("10000"))
        );
        return service;
    }

...
public class TradeFluxTestMock extends BaseTest {
    ...
    public TradeService tradeService() {
        ...
        TradeDTO trade01 = TradeDTO.builder()
                .tradeId("TRADE_0000001")
                .type(BID)
                ...
                .userReference("Ref TRADE_0000001")
                .timestamp(createDate(1))
                .build();
        TradeDTO trade02 = TradeDTO.builder()
                .tradeId("TRADE_0000002")
                .type(BID)
                .orderId("ORDER_0000001")
                .currencyPair(cp1)
                .amount(new CurrencyAmountDTO("1.100001", cp1.getBaseCurrency()))
                .price(new CurrencyAmountDTO("2.200002", cp1.getQuoteCurrency()))
                .fee(new CurrencyAmountDTO(new BigDecimal("3.300003"), BTC))
                .userReference("Ref TRADE_0000002")
        ...
        TradeDTO trade03 = TradeDTO.builder()
                .tradeId("TRADE_0000003")
                .type(BID)
                .orderId("ORDER_0000002")
                .currencyPair(cp2)
                .amount(new CurrencyAmountDTO("1.100001", cp2.getBaseCurrency()))
                .price(new CurrencyAmountDTO("2.200002", cp2.getQuoteCurrency()))
                .fee(new CurrencyAmountDTO(new BigDecimal("3.300003"), BTC))
                .userReference("Ref TRADE_0000003")
                .timestamp(createZonedDateTime("01-09-2020"))
                .build();
        TradeDTO trade04 = TradeDTO.builder()
                .tradeId("TRADE_0000004")
                .type(BID)
                .orderId("ORDER_0000001")
                .currencyPair(cp1)
                ...
                .price(new CurrencyAmountDTO("2.200002", cp1.getQuoteCurrency()))
                .fee(new CurrencyAmountDTO(new BigDecimal("3.300003"), BTC))
                .userReference("Ref TRADE_0000004")
                .timestamp(createZonedDateTime("01-09-2020"))
                .build();
        TradeDTO trade05 = TradeDTO.builder()
                .tradeId("TRADE_0000005")
                .type(BID)
                .orderId("ORDER_0000001")
                .currencyPair(cp1)
                .amount(new CurrencyAmountDTO("1", cp1.getBaseCurrency()))
                .price(new CurrencyAmountDTO("2.200002", cp1.getQuoteCurrency()))
                .fee(new CurrencyAmountDTO(new BigDecimal("3.300003"), BTC))
                .userReference("Ref TRADE_0000005")
                .timestamp(createZonedDateTime("01-09-2020"))
                .build();
        ...
        // =========================================================================================================
        // First reply : 4 trades - Trade07 is trade 0000003 again.
        TradeDTO trade06 = TradeDTO.builder()
                .tradeId("TRADE_0000006")
                .type(BID)
                .orderId("ORDER_0000001")
                .currencyPair(cp2)
                .amount(new CurrencyAmountDTO("1.100001", cp2.getBaseCurrency()))
                .price(new CurrencyAmountDTO("2.200002", cp2.getQuoteCurrency()))
                .fee(new CurrencyAmountDTO(new BigDecimal("3.300003"), BTC))
                .userReference("Ref TRADE_0000006")
                .timestamp(createZonedDateTime("02-09-2020"))
                .build();
        TradeDTO trade07 = TradeDTO.builder()
                .tradeId("TRADE_0000002")
                .type(BID)
                .orderId("ORDER_0000001")
                .currencyPair(cp1)
        ...
        TradeDTO trade09 = TradeDTO.builder()
                ...
                .price(new CurrencyAmountDTO("2.200002", cp1.getQuoteCurrency()))
                .fee(new CurrencyAmountDTO(new BigDecimal("3.300003"), BTC))
                .userReference("Ref TRADE_0000008")
                .timestamp(createZonedDateTime("02-09-2020"))
                .build();

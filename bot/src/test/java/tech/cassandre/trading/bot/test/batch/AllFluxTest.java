...
public class AllFluxTest extends BaseTest {
	...
	public void multithreadedTest() {
		...
		assertTrue(testableStrategy.getTickersUpdateReceived().size() >= numberOfAccountsUpdateExpected);
		assertTrue(testableStrategy.getOrdersUpdateReceived().size() >= numberOfAccountsUpdateExpected);
	}
